...
<body>
    ...
    <div class="product">
        <img src="foto3/mercedes-maybach.jpg" alt="Product Image" class="product-image">
        <div class="product-details">
            <h3>MERCEDES MAYBACH</h3>
            <p>Mercedes Benz Maybach S-Class 2024 adalah 4 Seater Sedan yang tersedia dengan harga Rp 7,7 Milyar di Indonesia. It is available in 1 variants, 1 engine, and 1 transmissions option: Otomatis in the Indonesia. Dimensi Maybach S-Class adalah 5469 mm L x 2109 mm W x 1510 mm H. Pesaing terdekat Mercedes Benz Maybach S-Class adalah Rapide S.</p>
            <p class="price">IDR 1.910.000.000</p>
