...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/land.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Land Cruiser</h3>
        <p>
          Toyota Land Cruiser tersedia dalam pilihan mesin Diesel di Indonesia.
          Mobil Land Cruiser ini dikenal dengan performa yang tangguh dan desain
          yang mewah, cocok untuk berbagai medan. Berikut adalah spesifikasi
          detail dari Land Cruiser:
        </p>
        <ol>
          <li>Mesin: Diesel, kapasitas 4461 cc</li>
          <li>Transmisi: Otomatis</li>
          <li>Varian: 4x4</li>
          <li>tahun pemakaian : 2019</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Kilometer: 60.000 km</li>
          <li>Panjang: 4950 mm</li>
          <li>Lebar: 1980 mm</li>
          <li>Wheelbase: 2850 mm</li>
          <li>Ground clearance: 230 mm</li>
          <li>Kapasitas: 7 seater</li>
          <li>Harga: Rp.880.000.000</li>
        </ol>
        <p class="price">Rp.880.000.000</p>
