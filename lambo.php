...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/aventador.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Lamborghini Aventador</h3>
        <p>
          Lamborghini Aventador adalah mobil supercar dengan performa tinggi dan
          desain yang sangat agresif. Berikut adalah spesifikasi detail dari
          Lamborghini Aventador:
        </p>
        <ol>
          <li>Mesin: 6.5L V12</li>
          <li>Transmisi: Otomatis 7-kecepatan</li>
          <li>Tahun pemakaian: 2021</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Varian: Coupe</li>
          <li>Kapasitas: 2 penumpang</li>
          <li>Konsumsi BBM: 4 km/liter</li>
          <li>Panjang: 4943 mm</li>
          <li>Lebar: 2273 mm</li>
          <li>Tinggi: 1136 mm</li>
          <li>Berat kosong: 1575 kg</li>
          <li>Harga: Rp. 15.000.000.000</li>
        </ol>
        <p class="price">Rp. 6.400.000.000</p>
