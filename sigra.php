...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/sigra.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Daihatsu Sigra R</h3>
        <p>
          Daihatsu Sigra R adalah mobil MPV kompak yang dirancang untuk
          mobilitas perkotaan dengan efisiensi bahan bakar yang optimal. Berikut
          adalah spesifikasi detail dari Daihatsu Sigra R:
        </p>
        <ol>
          <li>Mesin: 4 Silinder, 998 cc</li>
          <li>Transmisi: Manual atau Otomatis</li>
          <li>Varian: R</li>
          <li>Usia: 2 tahun</li>
          <li>Kilometer: 25.000 km</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Kapasitas: 7 penumpang</li>
          <li>Konsumsi BBM: 22 km/liter</li>
          <li>Panjang: 4070 mm</li>
          <li>Lebar: 1665 mm</li>
          <li>Tinggi: 1695 mm</li>
          <li>Berat kosong: 930 kg</li>
          <li>Harga: Rp.105.000.000 (estimasi)</li>
        </ol>
        <p class="price">Rp.105.000.000</p>
