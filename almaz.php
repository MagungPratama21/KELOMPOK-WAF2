...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/almaz.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Wuling Almaz</h3>
        <p>
          Wuling Almaz adalah SUV mewah dengan teknologi canggih dan ruang kabin
          yang luas. Mobil ini cocok untuk keluarga modern dengan gaya hidup
          aktif. Berikut adalah spesifikasi detail dari Wuling Almaz:
        </p>
        <ol>
          <li>Mesin: 4 Silinder, 1499 cc Turbo</li>
          <li>Transmisi: Otomatis CVT</li>
          <li>Varian: Almaz</li>
          <li>Usia: 2 tahun</li>
          <li>Kilometer: 40.000 km</li>
          <li>Kondisi: Sangat baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Kapasitas: 7 penumpang</li>
          <li>Panjang: 4765 mm</li>
          <li>Lebar: 1830 mm</li>
          <li>Tinggi: 1760 mm</li>
          <li>Berat kosong: 1540 - 1590 kg (tergantung varian)</li>
          <li>Ground clearance: 200 mm</li>
          <li>Harga: Rp. 350.000.000 (estimasi)</li>
        </ol>
        <p class="price">Rp. 350.000.000</p>
