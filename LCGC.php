...
<html lang="en">
  ...
  <body>
    ...
    <section class="spare-part" id="spare-part">
      <div class="header">
        <h2 class="highlight">LCGC CAR</h2>
        <p>Berikut Merupakan Mobil Terbaik Masa Kini</p>
      </div>
      <div class="contentsuv-container">
        <div class="contentsuv">
          <img src="foto/ayla.jpg" alt="Mobil Alya" />
          <h3>Ayla</h3>
          <h3>Rp.70.000.000</h3>
          <div class="bagi">
            <a href="ayla.php" class="button">review</a>
          </div>
        </div>
        <div class="contentsuv">
          <img src="foto/agya.jpg" alt="Mobil Agya" />
          <h3>Agya</h3>
          <h3>Rp.70.000.000</h3>
          <div class="bagi">
            <a href="agya.php" class="button">review</a>
          </div>
        </div>
        <div class="contentsuv">
          <img src="foto/calya.jpg" alt="Mobil Calya" />
          <h3>Calya</h3>
          <h3>Rp.110.000.000</h3>
          <div class="bagi">
            <a href="calya.php" class="button">review</a>
          </div>
        </div>
        <div class="contentsuv">
          <img src="foto/sigra.jpg" alt="Mobil Sigra" />
          <h3>Sigra</h3>
          <h3>Rp.105.000.000</h3>
          <div class="bagi">
            <a href="sigra.php" class="button">review</a>
          </div>
        </div>
        <div class="contentsuv">
          <img src="foto/brio.jpg" alt="Mobil Brio" />
          <h3>Brio</h3>
          <h3>Rp.80.000.000</h3>
          <div class="bagi">
            <a href="brio.php" class="button">review</a>
          </div>
        </div>
          </div>
        </div>
