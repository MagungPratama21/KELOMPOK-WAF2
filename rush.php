...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/rush.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>RUSH TRD</h3>
        <p>
          Toyota Rush TRD tersedia dalam pilihan mesin Bensin di Indonesia Mobil
          Terios tersedia dalam varian 2 SUV dan 8 Crossover.
        </p>
        <ol>
          <li>Mesin: Bensin, kapasitas 1496 cc</li>
          <li>Transmisi: Manual</li>
          <li>tahun pemakaian : 2020</li>
          <li>Varian: 2 varian SUV dan 8 varian Crossover</li>
          <li>kilometer : 50.000 rb</li>
          <li>Kondisi: Baik</li>
