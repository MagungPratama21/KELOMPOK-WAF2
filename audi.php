...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/audi.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Audi TTS Coupe</h3>
        <p>
          Audi TTS Coupe adalah mobil sport dengan desain dinamis dan performa
          tinggi. Berikut adalah spesifikasi detail dari Audi TTS Coupe:
        </p>
        <ol>
          <li>Mesin: 2.0L Turbocharged Inline-4</li>
          ...
          <li>Konsumsi BBM: 12 km/liter</li>
          <li>Panjang: 4191 mm</li>
          <li>Lebar: 1832 mm</li>
          <li>Tinggi: 1343 mm</li>
          <li>Berat kosong: 1410 kg</li>
          <li>Harga: Rp. 1.500.000.000</li>
        </ol>
