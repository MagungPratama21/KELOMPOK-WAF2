  ...
  <body>
    ...
    <div class="product">
      ...
      <div class="product-details">
        ...
        <p>
          Ferrari 488 GTB adalah mobil supercar dengan performa tinggi dan
          desain yang ikonik. Berikut adalah spesifikasi detail dari Ferrari 488
          GTB:
        </p>
        <ol>
          <li>Mesin: 3.9L Twin-Turbocharged V8</li>
          ...
          <li>Konsumsi BBM: 8 km/liter</li>
          <li>Panjang: 4568 mm</li>
          <li>Lebar: 1952 mm</li>
          <li>Tinggi: 1213 mm</li>
          <li>Berat kosong: 1475 kg</li>
          <li>Harga: Rp. 4.220.000.000</li>
        </ol>
        <p class="price">Rp. 4.220.000.000</p>
