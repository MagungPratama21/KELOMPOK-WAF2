...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/fortuner.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>FORTUNER TRD</h3>
        <p>
          Toyota Fortuner TRD tersedia dalam pilihan mesin Bensin di Indonesia.
          Mobil Fortuner ini dikenal dengan performa yang tangguh dan desain
          yang mewah, cocok untuk berbagai medan. Berikut adalah spesifikasi
          detail dari Fortuner TRD:
        </p>
        <ol>
          <li>Mesin: deasel, kapasitas 2755 cc</li>
          <li>Transmisi: Otomatis</li>
          <li>Varian: 4x2</li>
          <li>Kilometer: 50.000 km</li>
          <li>tahun pemakaian : 2020</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Panjang: 4795 mm</li>
          <li>Lebar: 1855 mm</li>
          <li>Wheelbase: 2745 mm</li>
          <li>Ground clearance: 225 mm</li>
          <li>Kapasitas: 7 seater</li>
          <li>Harga: Rp. 450.000.000</li>
        </ol>
        <p class="price">Rp. 450.000.000</p>
