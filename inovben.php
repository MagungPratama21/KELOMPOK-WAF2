...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/rebornb.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Innova Reborn Bensin</h3>
        <p>
          Toyota Innova Reborn Bensin tersedia dalam pilihan mesin Bensin di
          Indonesia. Mobil Innova Reborn ini dikenal dengan performa yang handal
          dan kenyamanan yang tinggi, cocok untuk berbagai kebutuhan keluarga.
          Berikut adalah spesifikasi detail dari Innova Reborn Bensin:
        </p>
        <ol>
          <li>Mesin: Bensin, kapasitas 1998 cc</li>
