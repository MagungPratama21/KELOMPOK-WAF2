...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/audir8.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Audi R8</h3>
        <p>
          Audi R8 adalah mobil sport dengan performa tinggi dan desain yang
          elegan. Berikut adalah spesifikasi detail dari Audi R8:
        </p>
        <ol>
          <li>Mesin: 5.2L V10</li>
          <li>Transmisi: Otomatis 7-kecepatan S tronic</li>
          <li>Tahun pemakaian: 2021</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Varian: Coupe</li>
          <li>Kapasitas: 2 penumpang</li>
          <li>Konsumsi BBM: 7 km/liter</li>
          <li>Panjang: 4426 mm</li>
          <li>Lebar: 1940 mm</li>
          <li>Tinggi: 1240 mm</li>
          <li>Berat kosong: 1595 kg</li>
          <li>Harga: Rp. 6.500.000.000</li>
        </ol>
        <p class="price">Rp. 6.500.000.000</p>
