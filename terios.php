...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/terios.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Toyota Terios R</h3>
        <p>
          Toyota Terios R adalah SUV kompak yang cocok untuk berbagai kondisi
          medan di Indonesia dengan kenyamanan dan kehandalan yang teruji.
          Berikut adalah spesifikasi detail dari Toyota Terios R:
        </p>
        <ol>
          <li>Mesin: 4 Silinder, 1496 cc</li>
          ...
          <li>Lebar: 1695 mm</li>
          <li>Wheelbase: 2685 mm</li>
          <li>Ground clearance: 220 mm</li>
          <li>Harga: Rp. 210.000.000 (estimasi)</li>
        </ol>
        <p class="price">Rp. 210.000.000</p>
