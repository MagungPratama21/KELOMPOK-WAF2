...
<body>
    ...
    <div class="product">
        <img src="foto2/foto7.jpg" alt="Product Image" class="product-image">
        <div class="product-details">
            <h3>MERCEDES AMG GT</h3>
            <p>Mercedes Benz AMG GT 2024 adalah 4 Seater Coupe yang tersedia dengan harga Rp 3,4 Milyar di Indonesia. Ini tersedia dalam 2 warna, 1 varian, 1 pilihan mesin, dan 1 opsi transmisi: Otomatis di Indonesia. Dimensi AMG GT adalah 5060 mm L x 2070 mm W x 1455 mm H. Pesaing terdekat Mercedes Benz AMG GT adalah GranTurismo, Continental, GLE-Class dan 8 Series Gran Coupe.</p>
            <p class="price">IDR 2.720.000.000</p>
