...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/bmwi8.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>BMW i8</h3>
        <p>
          BMW i8 adalah mobil sport hybrid dengan performa tinggi dan desain
          futuristik. Berikut adalah spesifikasi detail dari BMW i8:
        </p>
        <ol>
          <li>Mesin: 1.5L Turbocharged Inline-3 + Motor Listrik</li>
          <li>Transmisi: Otomatis 6-kecepatan</li>
          <li>Tahun pemakaian: 2021</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Varian: Coupe</li>
          <li>Kapasitas: 4 penumpang</li>
          <li>Konsumsi BBM: 15 km/liter</li>
          <li>Panjang: 4689 mm</li>
          <li>Lebar: 1942 mm</li>
          <li>Tinggi: 1297 mm</li>
          <li>Berat kosong: 1560 kg</li>
          <li>Harga: Rp. 3.500.000.000</li>
        </ol>
        <p class="price">Rp. 3.500.000.000</p>
