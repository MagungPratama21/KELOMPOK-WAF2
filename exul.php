...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/expandul.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Expander Ultimate</h3>
        <p>
          Mitsubishi Expander Ultimate tersedia dalam pilihan mesin Bensin di
          Indonesia. Mobil Expander Ultimate ini dikenal dengan desain yang
          stylish dan fitur-fitur canggih, cocok untuk kebutuhan keluarga
          modern. Berikut adalah spesifikasi detail dari Expander Ultimate:
        </p>
        <ol>
          <li>Mesin: Bensin, kapasitas 1499 cc</li>
          ...
          <li>Panjang: 4475 mm</li>
          <li>Lebar: 1750 mm</li>
          <li>Wheelbase: 2775 mm</li>
