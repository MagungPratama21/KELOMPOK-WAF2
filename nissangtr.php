...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto2/foto5.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>NISSAN GTR</h3>
        <p>
          Nissan GT-R adalah supercar terkenal yang menggabungkan performa
          tinggi dengan teknologi canggih. Ditenagai oleh mesin V6 3.8L
          twin-turbo yang menghasilkan sekitar 565 hp, GT-R mampu mencapai
          akselerasi 0-100 km/jam dalam sekitar 2,9 detik dengan kecepatan
          maksimal sekitar 315 km/jam. Desainnya aerodinamis dan agresif, dengan
          interior yang dilengkapi fitur-fitur modern dan material berkualitas
