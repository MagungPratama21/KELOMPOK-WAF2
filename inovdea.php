...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/rebornd.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Innova Reborn Diesel</h3>
        <p>
          Toyota Innova Reborn Diesel tersedia dalam pilihan mesin Diesel di
          Indonesia. Mobil Innova Reborn ini dikenal dengan performa yang handal
          dan efisiensi bahan bakar yang tinggi, cocok untuk berbagai kebutuhan
          keluarga. Berikut adalah spesifikasi detail dari Innova Reborn Diesel:
        </p>
        <ol>
          <li>Mesin: Diesel, kapasitas 2393 cc</li>
          ...
          <li>Harga: Rp. 380.000.000</li>
        </ol>
        <p class="price">Rp. 380.000.000</p>
