  ...
  <body>
    ...
    <div class="product">
      ...
      <div class="product-details">
        ...
        <p>
          Chery Omoda E5 tersedia dalam pilihan mesin Bensin di Indonesia. Mobil
          Chery Omoda E5 ini dikenal dengan desain yang modern dan teknologi
          yang canggih, cocok untuk gaya hidup urban. Berikut adalah spesifikasi
          detail dari Chery Omoda E5:
        </p>
        <ol>
          <li>Mesin: Bensin, kapasitas 1498 cc</li>
          ...
          <li>Panjang: 4600 mm</li>
          <li>Lebar: 1825 mm</li>
          <li>Wheelbase: 2700 mm</li>
          <li>Ground clearance: 185 mm</li>
          <li>Kapasitas: 5 seater</li>
          <li>Harga: Rp. 550.000.000</li>
        </ol>
