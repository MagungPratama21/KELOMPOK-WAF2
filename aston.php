...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/aston.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Aston Martin Vantage</h3>
        <p>
          Aston Martin Vantage adalah mobil sport mewah dengan desain elegan dan
          performa tinggi. Berikut adalah spesifikasi detail dari Aston Martin
          Vantage:
        </p>
        <ol>
          <li>Mesin: V8 Twin-Turbo, 3982 cc</li>
          <li>Transmisi: Otomatis 8-kecepatan</li>
          <li>Tahun pemakaian: 2021</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Varian: Coupe</li>
          <li>Kapasitas: 2 penumpang</li>
          <li>Konsumsi BBM: 10 km/liter</li>
          <li>Panjang: 4465 mm</li>
          <li>Lebar: 1942 mm</li>
          <li>Tinggi: 1273 mm</li>
          <li>Berat kosong: 1530 kg</li>
          <li>Harga: Rp. 4.500.000.000</li>
        </ol>
        <p class="price">Rp. 4.500.000.000</p>
