...
<body>
    ...
    <div class="product">
        <img src="foto2/foto1.jpg" alt="Product Image" class="product-image">
        <div class="product-details">
            <h3>PORSCHE CAYMAN 718</h3>
            <p>Model 718 dibuat untuk olahraga itu. Mereka adalah roadster bermesin menengah yang menyatukan semangat sportif Porsche 718 yang legendaris dengan mobil sport masa depan dan mentransfernya ke jalanan dunia saat ini.</p>
            <p class="price">IDR 4.800.000.000</p>
