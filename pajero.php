...
<html lang="en">
  ...
  <body>
    ...
    <div class="product">
      <img src="foto/pajero.jpg" alt="Product Image" class="product-image" />
      <div class="product-details">
        <h3>Pajero Dakar</h3>
        <p>
          Mitsubishi Pajero Dakar tersedia dalam pilihan mesin Diesel di
          Indonesia. Mobil Pajero ini dikenal dengan performa yang tangguh dan
          desain yang mewah, cocok untuk berbagai medan. Berikut adalah
          spesifikasi detail dari Pajero Dakar:
        </p>
        <ol>
          <li>Mesin: Diesel, kapasitas 2442 cc</li>
          <li>Transmisi: Otomatis</li>
          <li>Varian: 4x4</li>
          <li>tahun pemakaian : 2020</li>
          <li>Kondisi: Baik</li>
          <li>Pemakaian: Pribadi</li>
          <li>Kilometer: 80.000 km</li>
          <li>Panjang: 4785 mm</li>
          <li>Lebar: 1815 mm</li>
          <li>Wheelbase: 2800 mm</li>
          <li>Ground clearance: 218 mm</li>
          <li>Kapasitas: 7 seater</li>
          <li>Harga: Rp. 430.000.000</li>
        </ol>
        <p class="price">Rp. 430.000.000</p>
